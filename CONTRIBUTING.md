...
- Logging runs through `lib_log_rich`'s scrubber and a second redaction pass in `adapters/config/secrets.py`; add a sensitive-key pattern there rather than redacting at the call site.
